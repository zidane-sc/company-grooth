                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label @error('banner') is-invalid @enderror" for="banner">Choose Banner</label>
                                        </div>
                                    </div>
                                    @error('banner')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label @error('image_description') is-invalid @enderror" for="image_description">Choose Image Description</label>
                                        </div>
                                    </div>
