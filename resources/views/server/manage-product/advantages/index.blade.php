            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex flex-row-reverse">
                        <a href="{{ route('advantages.create') }}" class="btn btn-info">Add Advantage</a>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('advantages.edit', $advantage->id) }}" class="btn btn-warning text-white btn-sm btn-100">
                        ...
                        <form action="{{ route('advantages.destroy', $advantage->id) }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-danger btn-sm mt-3 btn-100" onclick="return confirm('Apakah anda yakin ingin menghapus {{ $advantage->name }}?')">
...
@if (session('create'))
  <script>
    $(function() {
      ...
      Toast.fire({
        icon: 'success',
        title: 'Advantage added successfully!'
      })
    });
  </script>
@endif    
...
@if (session('update'))
  <script>
    $(function() {
      ...
      Toast.fire({
        icon: 'success',
        title: 'Advantage edited successfully!'
      })
    });
  </script>
@endif    
...
@if (session('delete'))
  <script>
    $(function() {
      ...
      Toast.fire({
        icon: 'success',
        title: 'Advantage deleted successfully!'
      })
    });
  </script>
@endif  
