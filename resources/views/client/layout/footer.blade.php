				...
				<div class="widget w-info">
					<div class="site-logo">
						...
						<div class="logo-text">
							...
							<div class="logo-sub-title">Lorem ipsum</div>
						</div>
					</div>
	...
	<div class="sub-footer">
		...
		<div class="container">
			<div class="row">
                ...
                <span>
                    Copyright © 2020 <a href="index-2.html" class="sub-footer__link">Grooth</a>
                </span>

					<span>Designed by <a href="https://themeforest.net/user/themefire/portfolio">Grooth-Team</a>
                    Developed by <a href="https://themeforest.net/user/crumina/portfolio">Grooth-Team.</a>
                </span>
				</div>
			</div>
		</div>
...
<div class="window-popup message-popup">
	...
	<div class="send-message-popup">
		...
		<form class="form-validate contact-form crumina-submit" method="post" data-nonce="crumina-submit-form-nonce" data-type="standard" action="https://html.crumina.net/html-utouch/modules/forms/submit.php">
			<div class="with-icon">
